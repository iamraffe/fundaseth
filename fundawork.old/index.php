...
<title>Fundawork - Inicio</title>
<!--<BASE href="http://fundaseth.es/proyectos/">-->
...
<div class="container_12">
	<div class="grid_9 logoContainer">
        ...
        <h2 style="display:none">Coworking</h2>
  		<span class="fundaworkLogo"><img src="images/logo_fundawork.png" width="380" alt="Fundawork logo"/></span>
...
<!--        <p>Teléfono: +34913981628</p>-->
  ...
  <div class="grid_8 intro">
  		<p>FUNDAWORK es un espacio de coworking en Madrid. Proporcionamos infraestructura y servicios para que nuestros miembros puedan centrarse en sus proyectos.</p>
  </div>
  <!-- end .grid_11 -->
  <div class="clear"></div> 
  <div class="grid_9 push_1" style="margin-top:75px; padding-left: 20px;"><!--style="background-color: #FBC423;"-->
  		<!--<span class="imageBorder"><img src="images/homeScreen.jpg" height="400px" alt="Salón principal del coworking Fundawork"/></span>-->
        <iframe width="560" height="315" src="//www.youtube.com/embed/bQicK1q6kkk?vq=hd720" allowfullscreen></iframe>
  </div>
  <div class="clear"></div> 
  <footer class="grid_9">
