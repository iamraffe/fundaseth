...
<head>
    ...
    <title>Seminario Internacional de Seguridad del Paciente y Excelencia Clínica quirónsalud | El trato hospitalario del futuro</title>
	...
	<div class="container-fluid">
		...
		<div id="logo-placeholder">
			<div class="container">
			  ...
			  <img id="logo" src="img/logo.svg" alt="quirónsalud">
			</div>
		</div>
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbar-primary-collapse">
		      <ul class="nav navbar-nav">
		        ...
		        <!-- <li><a href="comite-organizador.php">Comité organizador</a></li> -->
		        <li><a href="como-llegar.php">Cómo llegar</a></li>
		      </ul>
		    </div><!-- /.navbar-collapse -->
		  </div><!-- /.container-fluid -->
		</nav>
