		...
		<div class="standardcontainer" style="margin-top: -20px;">
			<div class="maincontent" style="background: #F6F6F6; padding: 25px; padding-top: 0;  min-height: 350px;">
				<div class="section group" style="margin-top: -50px;">
                	...
                	<div class="col span_3_of_4" style="font-size: 1.25em; color: #6C7A89;"> 
                	...
                	<div class="col span_1_of_4">
                    	<img src="img/walker.svg" style="width:90%; margin-left: 5px; margin-top: -20px;">
                    </div> 
                </div>
                <div class="section group" style="margin-top: -50px;">
                    <div style="font-style:italic; color: #a5a4a4; background: #FCFCFC; border: 1px dashed #2980B9; padding: 30px; margin: 30px; margin-left: 65px; font-family: 'Montserrat';  text-align: center;">
