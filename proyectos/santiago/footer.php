            ...
            <div class="section group">
                ...
                <div class="col span_3_of_4">
                    <form action="send.php" name="contact" method="post">
                        ...
                        <input type="email" name="email" required="required" placeholder="<?php echo ("Correo electrónico*"); ?>" style="float: right;" />
                        <textarea style="clear: right; float:right;" name="message" id="message" required placeholder=" <?php echo ("Escriba aquí sus comentarios..."); ?>" ></textarea>
                        <input style="" type="text" name="name" required="required" placeholder="<?php echo ("Nombre*"); ?>"  />
                        <input type="text" name="name" required="required" placeholder="<?php echo ("Apellidos*"); ?>" style=" float: left;"  />
                        <input  type="text" name="phone"  placeholder="<?php echo ("Teléfono (Opcional)"); ?>" style=" float: left;" />
                        <button type="submit" style="display:block; clear: right; float: right;"><?php echo ("Enviar"); ?></button>
                    </form>
            	</div>
            </div>
